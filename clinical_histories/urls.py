...
from .views import generate_clinical_history_pdf, clinical_history_list, clinical_history_create, clinical_history_update, clinical_history_delete
...
urlpatterns = [
    ...
    path('download_pdf/', generate_clinical_history_pdf, name='generate_clinical_history_pdf'),
]
